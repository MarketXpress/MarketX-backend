...
export class MilestonesController {
  ...
  async createMilestones(
    ...
    this.logger.log(`Creating ${createData.milestones.length} milestones for order ${createData.orderId}`);
    
    return this.milestonesService.createMilestones(createData.orderId, createData.milestones);
  }
  ...
  @ApiQuery({ name: 'dateFrom', description: 'Filter by date from', required: false })
  @ApiQuery({ name: 'dateTo', description: 'Filter by date to', required: false })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Statistics retrieved successfully'
  })

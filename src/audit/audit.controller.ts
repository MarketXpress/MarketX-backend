import { Controller, Get, Query, UseGuards, Param, ParseUUIDPipe, HttpException, HttpStatus } from '@nestjs/common';
...
export class AuditController {
  ...
  async getAuditStats(
    ...
    return this.auditService.getAuditStats(new Date(startDate), new Date(endDate));
  }
